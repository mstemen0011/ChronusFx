...
public class ChronusFXMLController implements Initializable {
    ...
    private void selectTimeSlot(ActionEvent event) {
        ...
        this.timeIsRunning = ts.hasStarted;
    ...
    private void focusCurrentTimeSlot() {
        ...
        if (this.timeSlotInFocus.hasStarted) {
            System.out.println("Current time slot has been started");
        } else {
            System.out.println("Current time slot has NOT been started");
        }
